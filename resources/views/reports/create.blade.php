            ...
            <div class="cg-card p-8">
                ...
                <form method="POST" action="{{ route('reports.store') }}" enctype="multipart/form-data" class="space-y-5">
                    ...
                    <div>
                        ...
                        <button type="button" id="use-location" class="mt-2 inline-flex items-center rounded-md bg-maroon-700 px-3 py-1.5 text-xs font-semibold text-white shadow-sm transition hover:bg-maroon-800">{{ __('Use My Current Location (Optional)') }}</button>
